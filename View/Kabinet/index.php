                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    ...
                                                    <input id="username" type="text" name="name" class="sign__input"
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    ...
                                                    <input id="email" type="email" name="email" class="sign__input"
                                                           placeholder=<?= email ?>>
                                                </div>
                                            </div>
