            ...
            <div class="row">
                ...
                ?>
                    ...
                    <p class="article__favorites" type="button">
                        <svg style="color: yellow;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-check" viewBox="0 0 16 16">
...
include_once "./Model/KabinetModel.php";
